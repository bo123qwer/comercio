                        ...
                        <div class="row">
                            <div class="span10 offset1">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="addr1">Dirección<span class="red-clr bold">*</span></label>
                                    <div class="controls">
                                ...
                                <p class="right-align">
                                    Elegir compra de puntos &nbsp; &nbsp;
                                    <a href="${pageContext.servletContext.contextPath }/pago.htm" class="btn btn-primary higher bold">CONTINUAR</a>
                                </p>
